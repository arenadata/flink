...
public final class ConfigConstants {
     ...
     */
    @Deprecated public static final String DEFAULT_PARALLELISM_KEY = "parallelism.default";
     ...
     */
    @Deprecated @PublicEvolving public static final String RESTART_STRATEGY = "restart-strategy";
    ...
    /**
     * Delay between two consecutive restart attempts in FixedDelayRestartStrategy. It can be
     ...
     * #RESTART_STRATEGY_FAILURE_RATE_FAILURE_RATE_INTERVAL} before failing a job in
     * FailureRateRestartStrategy.
     *
     * @deprecated use {@link
     *     RestartStrategyOptions#RESTART_STRATEGY_FAILURE_RATE_MAX_FAILURES_PER_INTERVAL} instead.
     */
    @Deprecated @PublicEvolving
    public static final String RESTART_STRATEGY_FAILURE_RATE_MAX_FAILURES_PER_INTERVAL =
            "restart-strategy.failure-rate.max-failures-per-interval";

    /**
     * Time interval in which greater amount of failures than {@link
     * #RESTART_STRATEGY_FAILURE_RATE_MAX_FAILURES_PER_INTERVAL} causes job fail in
     * FailureRateRestartStrategy. It can be specified using Scala's FiniteDuration notation: "1
     * min", "20 s"
     *
     * @deprecated use {@link
     ...
     */
    @Deprecated @PublicEvolving
    public static final String RESTART_STRATEGY_FAILURE_RATE_FAILURE_RATE_INTERVAL =
    ...
    /**
     * Config parameter for the number of re-tries for failed tasks. Setting this value to 0
     * effectively disables fault tolerance.
     *
     * @deprecated The configuration value will be replaced by {@link
     *     #RESTART_STRATEGY_FIXED_DELAY_ATTEMPTS} and the corresponding FixedDelayRestartStrategy.
     */
    @Deprecated @PublicEvolving
     ...
     *
     * @deprecated The configuration value will be replaced by {@link
     *     #RESTART_STRATEGY_FIXED_DELAY_DELAY} and the corresponding FixedDelayRestartStrategy.
     */
    @Deprecated @PublicEvolving
     ...
     */
    @Deprecated public static final String JOB_MANAGER_IPC_ADDRESS_KEY = "jobmanager.rpc.address";
    ...
    @Deprecated public static final String BLOB_STORAGE_DIRECTORY_KEY = "blob.storage.directory";

    /** @deprecated use {@link BlobServerOptions#FETCH_RETRIES} instead */
    @Deprecated public static final String BLOB_FETCH_RETRIES_KEY = "blob.fetch.retries";

    /** @deprecated use {@link BlobServerOptions#FETCH_CONCURRENT} instead */
    @Deprecated public static final String BLOB_FETCH_CONCURRENT_KEY = "blob.fetch.num-concurrent";

    /** @deprecated use {@link BlobServerOptions#FETCH_BACKLOG} instead */
    @Deprecated public static final String BLOB_FETCH_BACKLOG_KEY = "blob.fetch.backlog";

    /** @deprecated use {@link BlobServerOptions#PORT} instead */
    @Deprecated public static final String BLOB_SERVER_PORT = "blob.server.port";

    /** @deprecated use {@link BlobServerOptions#SSL_ENABLED} instead */
    @Deprecated public static final String BLOB_SERVICE_SSL_ENABLED = "blob.service.ssl.enabled";
     ...
     */
    @Deprecated public static final String TASK_MANAGER_HOSTNAME_KEY = "taskmanager.hostname";

    /** @deprecated use {@link TaskManagerOptions#RPC_PORT} instead */
    @Deprecated public static final String TASK_MANAGER_IPC_PORT_KEY = "taskmanager.rpc.port";

    /** @deprecated use {@link NettyShuffleEnvironmentOptions#DATA_PORT} instead */
    @Deprecated public static final String TASK_MANAGER_DATA_PORT_KEY = "taskmanager.data.port";
    ...
    /** @deprecated has no effect */
    @Deprecated
    public static final String TASK_MANAGER_MEMORY_PRE_ALLOCATE_KEY =
            "taskmanager.memory.preallocate";

    /**
     * The config parameter defining the number of buffers used in the network stack. This defines
     * the number of possible tasks and shuffles.
     *
    ...
    /**
     * Config parameter defining the size of memory buffers used by the network stack and the memory
     * manager.
     *
    ...
    /**
     * The initial registration pause between two consecutive registration attempts. The pause is
     * doubled for each new registration attempt until it reaches the maximum registration pause.
     *
    ...
    /**
     * The pause after a registration has been refused by the job manager before retrying to
     * connect.
     *
    ...
    /** @deprecated has no effect */
    @Deprecated public static final boolean DEFAULT_TASK_MANAGER_MEMORY_PRE_ALLOCATE = false;
    ...
    @Deprecated
    public static final String RUNTIME_HASH_JOIN_BLOOM_FILTERS_KEY =
     ...
     */
    @Deprecated public static final String YARN_VCORES = "yarn.containers.vcores";
     ...
     * @deprecated Not used anymore, but remain here until Flink 2.0
     */
    @Deprecated public static final String YARN_HEAP_CUTOFF_RATIO = "yarn.heap-cutoff-ratio";
     ...
     * @deprecated Not used anymore, but remain here until Flink 2.0
     */
    @Deprecated public static final String YARN_HEAP_CUTOFF_MIN = "yarn.heap-cutoff-min";
    ...
    /**
     * The maximum number of failed YARN containers before entirely stopping the YARN session / job
     * on YARN.
     *
     ...
     * mode. This value is usually limited by YARN.
     *
     ...
     */
    @Deprecated public static final String YARN_APPLICATION_ATTEMPTS = "yarn.application-attempts";

    /**
     * The heartbeat interval between the Application Master and the YARN Resource Manager. The
     * default value is 5 (seconds).
     *
     * @deprecated in favor of {@code YarnConfigOptions#HEARTBEAT_DELAY_SECONDS}.
     */
    @Deprecated public static final String YARN_HEARTBEAT_DELAY_SECONDS = "yarn.heartbeat-delay";
    ...
    /** @deprecated Not used anymore, but remain here until Flink 2.0 */
    @Deprecated public static final String DEFAULT_YARN_APPLICATION_MASTER_PORT = "deprecated";

    /** @deprecated Not used anymore, but remain here until Flink 2.0 */
    @Deprecated public static final int DEFAULT_YARN_MIN_HEAP_CUTOFF = -1;
     ...
     * JobManager
     *
     * <p>The port can either be a port, such as "9123", a range of ports: "50100-50200" or a list
     * of ranges and or points: "50100-50200,50300-50400,51234"
     *
     ...
     */
    @Deprecated public static final String YARN_APPLICATION_TAGS = "yarn.tags";
    ...
    /**
     * Key to specify the default filesystem to be used by a job. In the case of <code>file:///
     * </code>, which is the default (see {@link ConfigConstants#DEFAULT_FILESYSTEM_SCHEME}), the
     * local filesystem is going to be used to resolve URIs without an explicit scheme.
     *
     * @deprecated Use {@link CoreOptions#DEFAULT_FILESYSTEM_SCHEME} instead.
     */
    @Deprecated public static final String FILESYSTEM_SCHEME = "fs.default-scheme";
     ...
     */
    @Deprecated public static final String FILESYSTEM_DEFAULT_OVERWRITE_KEY = "fs.overwrite-files";

    /**
     * Key to specify whether the file systems should always create a directory for the output, even
    ...
    /**
     * The maximum number of line samples to be taken by the delimited input format, if no other
     * value is specified for the data source.
     *
    ...
    /**
     * The minimum number of line samples to be taken by the delimited input format, if no other
     * value is specified for the data source.
     *
     ...
     */
    @Deprecated public static final String JOB_MANAGER_WEB_TMPDIR_KEY = "jobmanager.web.tmpdir";
     ...
     */
    @Deprecated public static final String JOB_MANAGER_WEB_ARCHIVE_COUNT = "jobmanager.web.history";
     ...
     */
    @Deprecated public static final String JOB_MANAGER_WEB_LOG_PATH_KEY = "jobmanager.web.log.path";
     ...
     * @deprecated This option is no longer used and has no effect on Flink.
     */
    @Deprecated public static final String AKKA_WATCH_THRESHOLD = "akka.watch.threshold";
     ...
     */
    @Deprecated public static final String AKKA_CLIENT_TIMEOUT = "akka.client.timeout";
    ...
    @Deprecated public static final String SECURITY_SSL_ENABLED = "security.ssl.enabled";

    /** @deprecated use {@link SecurityOptions#SSL_KEYSTORE} instead */
    @Deprecated public static final String SECURITY_SSL_KEYSTORE = "security.ssl.keystore";
    ...
    @Deprecated public static final String SECURITY_SSL_KEY_PASSWORD = "security.ssl.key-password";

    /** @deprecated use {@link SecurityOptions#SSL_TRUSTSTORE} instead */
    @Deprecated public static final String SECURITY_SSL_TRUSTSTORE = "security.ssl.truststore";
    ...
    @Deprecated public static final String SECURITY_SSL_PROTOCOL = "security.ssl.protocol";

    /** @deprecated use {@link SecurityOptions#SSL_ALGORITHMS} instead */
    @Deprecated public static final String SECURITY_SSL_ALGORITHMS = "security.ssl.algorithms";
     ...
     */
    @Deprecated public static final String STATE_BACKEND = "state.backend";

    // ----------------------------- Miscellaneous ----------------------------

    /**
     * The key to the Flink base directory path. Was initially used for configurations of the web
     * UI, but outdated now.
     *
     * @deprecated This parameter should not be used any more. A running Flink cluster should make
     *     no assumption about its location.
     */
    @Deprecated public static final String FLINK_BASE_DIR_PATH_KEY = "flink.base.dir.path";

    /** @deprecated Use {@link CoreOptions#FLINK_JVM_OPTIONS} instead. */
    @Deprecated public static final String FLINK_JVM_OPTIONS = "env.java.opts";
    ...
    @Deprecated public static final String RECOVERY_MODE = "recovery.mode";

    /** @deprecated Deprecated in favour of {@link #HA_JOB_MANAGER_PORT}. */
    @Deprecated public static final String RECOVERY_JOB_MANAGER_PORT = "recovery.jobmanager.port";

    /** @deprecated This option is no longer used and has no effect on Flink. */
    @Deprecated public static final String RECOVERY_JOB_DELAY = "recovery.job.delay";
    ...
    @Deprecated public static final String ZOOKEEPER_QUORUM_KEY = "recovery.zookeeper.quorum";
    ...
    @Deprecated public static final String ZOOKEEPER_DIR_KEY = "recovery.zookeeper.path.root";
    ...
    @Deprecated public static final String ZOOKEEPER_LATCH_PATH = "recovery.zookeeper.path.latch";

    /** @deprecated Deprecated in favour of {@link #HA_ZOOKEEPER_LEADER_PATH}. */
    @Deprecated public static final String ZOOKEEPER_LEADER_PATH = "recovery.zookeeper.path.leader";
    ...
    @Deprecated public static final String METRICS_SCOPE_NAMING_JM = "metrics.scope.jm";

    /** @deprecated Use {@link MetricOptions#SCOPE_NAMING_TM} instead. */
    @Deprecated public static final String METRICS_SCOPE_NAMING_TM = "metrics.scope.tm";

    /** @deprecated Use {@link MetricOptions#SCOPE_NAMING_JM_JOB} instead. */
    @Deprecated public static final String METRICS_SCOPE_NAMING_JM_JOB = "metrics.scope.jm.job";

    /** @deprecated Use {@link MetricOptions#SCOPE_NAMING_TM_JOB} instead. */
    @Deprecated public static final String METRICS_SCOPE_NAMING_TM_JOB = "metrics.scope.tm.job";

    /** @deprecated Use {@link MetricOptions#SCOPE_NAMING_TASK} instead. */
    @Deprecated public static final String METRICS_SCOPE_NAMING_TASK = "metrics.scope.task";

    /** @deprecated Use {@link MetricOptions#SCOPE_NAMING_OPERATOR} instead. */
    @Deprecated public static final String METRICS_SCOPE_NAMING_OPERATOR = "metrics.scope.operator";
     ...
     *     configuration. We now always use the FileSystem for savepoints. For this, the only
     *     relevant config key is {@link CheckpointingOptions#SAVEPOINT_DIRECTORY}.
     */
    @Deprecated
    ...
    /** @deprecated use {@link JobManagerOptions#PORT} instead */
    @Deprecated public static final int DEFAULT_JOB_MANAGER_IPC_PORT = 6123;
     ...
     * @deprecated Use {@link ResourceManagerOptions#IPC_PORT} instead.
     */
    @Deprecated public static final int DEFAULT_RESOURCE_MANAGER_IPC_PORT = 0;

    /** @deprecated use {@link BlobServerOptions#SSL_ENABLED} instead */
    @Deprecated public static final boolean DEFAULT_BLOB_SERVICE_SSL_ENABLED = true;

    /** @deprecated use {@link BlobServerOptions#FETCH_RETRIES} instead */
    @Deprecated public static final int DEFAULT_BLOB_FETCH_RETRIES = 5;

    /** @deprecated use {@link BlobServerOptions#FETCH_CONCURRENT} instead */
    @Deprecated public static final int DEFAULT_BLOB_FETCH_CONCURRENT = 50;

    /** @deprecated use {@link BlobServerOptions#FETCH_BACKLOG} instead */
    @Deprecated public static final int DEFAULT_BLOB_FETCH_BACKLOG = 1000;

    /** @deprecated use {@link BlobServerOptions#PORT} instead */
    @Deprecated public static final String DEFAULT_BLOB_SERVER_PORT = "0";

    /** @deprecated use {@link TaskManagerOptions#RPC_PORT} instead */
    @Deprecated public static final int DEFAULT_TASK_MANAGER_IPC_PORT = 0;
     ...
     * @deprecated use {@link NettyShuffleEnvironmentOptions#DATA_PORT} instead
     */
    @Deprecated public static final int DEFAULT_TASK_MANAGER_DATA_PORT = 0;
     ...
     * @deprecated use {@link NettyShuffleEnvironmentOptions#DATA_SSL_ENABLED} instead
     */
    @Deprecated public static final boolean DEFAULT_TASK_MANAGER_DATA_SSL_ENABLED = true;
    ...
    /** @deprecated has no effect */
    @Deprecated public static final float DEFAULT_MEMORY_MANAGER_MEMORY_FRACTION = 0.7f;

    /**
     * Config key has been deprecated. Therefore, no default value required.
     *
     * @deprecated {@link NettyShuffleEnvironmentOptions#NETWORK_NUM_BUFFERS} provides the default
     *     value now
     */
    @Deprecated public static final int DEFAULT_TASK_MANAGER_NETWORK_NUM_BUFFERS = 2048;
     ...
     */
    @Deprecated public static final int DEFAULT_TASK_MANAGER_MEMORY_SEGMENT_SIZE = 32768;

    /** @deprecated Not used anymore */
    @Deprecated public static final String DEFAULT_TASK_MANAGER_NETWORK_DEFAULT_IO_MODE = "sync";
     ...
     * @deprecated use {@link TaskManagerOptions#REGISTRATION_TIMEOUT} instead
     */
    @Deprecated public static final String DEFAULT_TASK_MANAGER_MAX_REGISTRATION_DURATION = "Inf";
     ...
     * @deprecated use {@link ClusterOptions#MAX_REGISTRATION_TIMEOUT} instead
     */
    @Deprecated public static final String DEFAULT_TASK_MANAGER_MAX_REGISTRATION_PAUSE = "30 s";
     ...
     * @deprecated use {@link ClusterOptions#REFUSED_REGISTRATION_DELAY} instead
     */
    @Deprecated public static final String DEFAULT_TASK_MANAGER_REFUSED_REGISTRATION_PAUSE = "10 s";

    /** @deprecated Please use {@link TaskManagerOptions#TASK_CANCELLATION_INTERVAL}. */
    @Deprecated public static final long DEFAULT_TASK_CANCELLATION_INTERVAL_MILLIS = 30000;

    // ------------------------ Runtime Algorithms ------------------------

    /** @deprecated use {@link AlgorithmOptions#HASH_JOIN_BLOOM_FILTERS} instead */
    @Deprecated public static final boolean DEFAULT_RUNTIME_HASH_JOIN_BLOOM_FILTERS = false;

    /** @deprecated use {@link AlgorithmOptions#SPILLING_MAX_FAN} insstead */
    @Deprecated public static final int DEFAULT_SPILLING_MAX_FAN = 128;

    /** @deprecated use {@link AlgorithmOptions#SORT_SPILLING_THRESHOLD} instead */
    @Deprecated public static final float DEFAULT_SORT_SPILLING_THRESHOLD = 0.8f;
     ...
     */
    @Deprecated public static final boolean DEFAULT_USE_LARGE_RECORD_HANDLER = false;

    // ------ Common Resource Framework Configuration (YARN & Mesos) ------

    /**
     * Minimum amount of memory to subtract from the process memory to get the TaskManager heap
     * size. We came up with these values experimentally.
     *
     * @deprecated Not used anymore, but remain here until Flink 2.0
     */
    @Deprecated public static final int DEFAULT_YARN_HEAP_CUTOFF = 600;

    /**
     * Relative amount of memory to subtract from Java process memory to get the TaskManager heap
     * size.
     *
     * @deprecated Not used anymore, but remain here until Flink 2.0
     */
    ...
    /**
     * Default port for the application master is 0, which means the operating system assigns an
     * ephemeral port.
     *
     * @deprecated in favor of {@code YarnConfigOptions#APPLICATION_MASTER_PORT}.
     */
    @Deprecated public static final String DEFAULT_YARN_JOB_MANAGER_PORT = "0";
     ...
     * @deprecated Use {@link CoreOptions#FILESYSTEM_OUTPUT_ALWAYS_CREATE_DIRECTORY} instead.
     */
    @Deprecated public static final boolean DEFAULT_FILESYSTEM_ALWAYS_CREATE_DIRECTORY = false;
     ...
     * @deprecated use {@link OptimizerOptions#DELIMITED_FORMAT_MAX_LINE_SAMPLES} instead
     */
    @Deprecated public static final int DEFAULT_DELIMITED_FORMAT_MAX_LINE_SAMPLES = 10;
     ...
     * @deprecated use {@link OptimizerOptions#DELIMITED_FORMAT_MIN_LINE_SAMPLES} instead
     */
    @Deprecated public static final int DEFAULT_DELIMITED_FORMAT_MIN_LINE_SAMPLES = 2;
     ...
     * @deprecated use {@link OptimizerOptions#DELIMITED_FORMAT_MAX_SAMPLE_LEN} instead
     */
    @Deprecated public static final int DEFAULT_DELIMITED_FORMAT_MAX_SAMPLE_LEN = 2 * 1024 * 1024;
     ...
     * disables the web frontend.
     *
     * @deprecated use {@link WebOptions#PORT} instead
     */
    @Deprecated public static final int DEFAULT_JOB_MANAGER_WEB_FRONTEND_PORT = 8081;
     ...
     * @deprecated use {@link WebOptions#SSL_ENABLED} instead
     */
    @Deprecated public static final boolean DEFAULT_JOB_MANAGER_WEB_SSL_ENABLED = true;
     ...
     * @deprecated use {@link WebOptions#ARCHIVE_COUNT} instead
     */
    @Deprecated public static final int DEFAULT_JOB_MANAGER_WEB_ARCHIVE_COUNT = 5;
     ...
     * @deprecated use {@link WebOptions#SUBMIT_ENABLE} instead
     */
    @Deprecated public static final boolean DEFAULT_JOB_MANAGER_WEB_SUBMIT_ENABLED = true;

    /** @deprecated Config key has been deprecated. Therefore, no default value required. */
    @Deprecated public static final boolean DEFAULT_JOB_MANAGER_WEB_CHECKPOINTS_DISABLE = false;
     ...
     * @deprecated use {@link WebOptions#CHECKPOINTS_HISTORY_SIZE} instead
     */
    @Deprecated public static final int DEFAULT_JOB_MANAGER_WEB_CHECKPOINTS_HISTORY_SIZE = 10;
     ...
     */
    @Deprecated
    public static final int DEFAULT_JOB_MANAGER_WEB_BACK_PRESSURE_CLEAN_UP_INTERVAL =
            10 * 60 * 1000;
     ...
     */
    @Deprecated public static final int DEFAULT_JOB_MANAGER_WEB_BACK_PRESSURE_NUM_SAMPLES = 100;
     ...
     */
    @Deprecated public static final int DEFAULT_JOB_MANAGER_WEB_BACK_PRESSURE_DELAY = 50;
    ...
    /** @deprecated use {@link SecurityOptions#SSL_ENABLED} instead */
    @Deprecated public static final boolean DEFAULT_SECURITY_SSL_ENABLED = false;

    /** @deprecated use {@link SecurityOptions#SSL_PROTOCOL} instead */
    @Deprecated public static final String DEFAULT_SECURITY_SSL_PROTOCOL = "TLSv1.2";
    ...
    /** @deprecated use {@link SecurityOptions#SSL_VERIFY_HOSTNAME} instead */
    @Deprecated public static final boolean DEFAULT_SECURITY_SSL_VERIFY_HOSTNAME = true;
    ...
    /** @deprecated Use {@link ResourceManagerOptions#LOCAL_NUMBER_RESOURCE_MANAGER} instead. */
    @Deprecated public static final int DEFAULT_LOCAL_NUMBER_RESOURCE_MANAGER = 1;

    /** @deprecated Has no effect; the web-server is always started. Will be removed in 2.0. */
    @Deprecated public static final String LOCAL_START_WEBSERVER = "local.start-webserver";

    // --------------------------- High Availability ---------------------------------

    /** @deprecated Deprecated in favour of {@link HighAvailabilityOptions#HA_MODE} */
    @PublicEvolving @Deprecated public static final String DEFAULT_HA_MODE = "none";
     ...
     * @deprecated No longer used.
     */
    @PublicEvolving @Deprecated public static final String DEFAULT_HA_JOB_MANAGER_PORT = "0";

    /** @deprecated Deprecated in favour of {@link #DEFAULT_HA_JOB_MANAGER_PORT} */
    @Deprecated public static final String DEFAULT_RECOVERY_JOB_MANAGER_PORT = "0";

    // --------------------------- ZooKeeper ----------------------------------

    /** @deprecated in favor of {@link HighAvailabilityOptions#HA_ZOOKEEPER_ROOT}. */
    @Deprecated public static final String DEFAULT_ZOOKEEPER_DIR_KEY = "/flink";
    ...
    /** @deprecated in favor of {@link HighAvailabilityOptions#ZOOKEEPER_SESSION_TIMEOUT}. */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_SESSION_TIMEOUT = 60000;

    /** @deprecated in favor of {@link HighAvailabilityOptions#ZOOKEEPER_CONNECTION_TIMEOUT}. */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_CONNECTION_TIMEOUT = 15000;

    /** @deprecated in favor of {@link HighAvailabilityOptions#ZOOKEEPER_RETRY_WAIT}. */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_RETRY_WAIT = 5000;

    /** @deprecated in favor of {@link HighAvailabilityOptions#ZOOKEEPER_MAX_RETRY_ATTEMPTS}. */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_MAX_RETRY_ATTEMPTS = 3;
     ...
     */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_CLIENT_PORT = 2181;
     ...
     */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_INIT_LIMIT = 10;
     ...
     */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_SYNC_LIMIT = 5;
     ...
     */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_PEER_PORT = 2888;
     ...
     */
    @Deprecated public static final int DEFAULT_ZOOKEEPER_LEADER_PORT = 3888;
     ...
     * @deprecated in favor of {@link SecurityOptions#ZOOKEEPER_SASL_DISABLE}.
     */
    @Deprecated public static final boolean DEFAULT_ZOOKEEPER_SASL_DISABLE = true;
     ...
     * @deprecated in favor of {@link HighAvailabilityOptions#ZOOKEEPER_CLIENT_ACL}.
     */
    @Deprecated public static final String DEFAULT_HA_ZOOKEEPER_CLIENT_ACL = "open";

    // ----------------------------- Metrics ----------------------------

    /** @deprecated Use {@link MetricOptions#LATENCY_HISTORY_SIZE} instead. */
    @Deprecated public static final int DEFAULT_METRICS_LATENCY_HISTORY_SIZE = 128;
